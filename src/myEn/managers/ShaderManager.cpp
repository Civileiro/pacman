...
ShaderManager::ShaderManager(std::string_view vertexFileName, std::string_view fragmentFileName) {
	...
	const GLuint vertex =
		createShader(GL_VERTEX_SHADER, readShaderFile(vertexFileName.data()), shaderType::VERTEX);
	const GLuint fragment =
		createShader(GL_FRAGMENT_SHADER, readShaderFile(fragmentFileName.data()), shaderType::FRAGMENT);
